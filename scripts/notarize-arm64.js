...
async function notarizeArm64() {
  ...
  const appleId = process.env.APPLE_ID || 'your-apple-id@example.com';
  const appleIdPassword = process.env.APPLE_APP_SPECIFIC_PASSWORD || 'your-app-specific-password';
  const appleTeamId = process.env.APPLE_TEAM_ID || 'your-team-id';
