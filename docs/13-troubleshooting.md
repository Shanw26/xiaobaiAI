...
1. **确认 Key 类型**：
   ...
   sbp_7eb9c71d4c5416a5f776abd29a20334efc49e4cb

   # Service Role Key（用于服务端，JWT 格式）
   eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNuc3pvb2F4d3hhdGV6b2RiYnhxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NzY4NjIwMCwiZXhwIjoyMDgzMjYyMjAwfQ.ErS93xT_ljnPe_zQNIWV3mTHJtKASV2a7g2odPo0nXY

   # Anon Key（用于客户端，JWT 格式）
   eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImM5bnpvd3h3eXRnd2t4X2tqbXFQM2pRIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzYxNzYwNDksImV4cCI6MjA1MTc1MjA0OX0.W2sNZ5Xh8q_nDQTpYuHMPNMm2W0VQQFnqpeuJNVwPLY
   ```
